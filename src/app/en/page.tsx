...
export default function HomeEn() {
  return (
    <Layout>
      <PageShell
        watermarkLabel="RS"
        watermarkClassName="text-[260px] md:text-[300px]"
        background={
          <>
      ...
      >
        <div className="w-full max-w-5xl mx-auto px-6 md:px-8 flex flex-col flex-shrink-0 pt-16 md:pt-20 pb-20 md:pb-28">
          <AnimatedSection delay={0.3} className="text-left flex-shrink-0">
            <p className="text-sm uppercase tracking-[0.32em] text-foreground/60 mb-4">Frontend · Next.js · AI</p>
          ...
          <AnimatedSection delay={0.7}>
            <p className="text-base md:text-lg text-foreground/80 max-w-xl leading-relaxed">
              I&apos;m a frontend developer from Italy, working with React, Next.js and a bit of AI to help you
              move faster without sacrificing quality. Below you can find a few selected projects and how I
              work.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={1.3} className="flex-shrink-0">
            <div className="space-y-3 text-sm md:text-base text-foreground/70">
              <p className="font-medium text-foreground">A few highlighted projects (case studies in Italian):</p>
              ...
              <p className="text-xs md:text-sm text-foreground/60">
                Full case studies are written in Italian, but the structure of the work and screenshots are easy
                to follow.
              </p>
            </div>
          </AnimatedSection>
